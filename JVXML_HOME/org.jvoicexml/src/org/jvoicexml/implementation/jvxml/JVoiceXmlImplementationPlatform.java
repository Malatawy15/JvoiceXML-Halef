...
public final class JVoiceXmlImplementationPlatform
    ...
    */
	...
	String recogResult = "\n"+ "Time ("+now()+")" +"\n"+"Recognized String : "
			    ...
			    + "( "+result.getMode()+" )" +"\n"+"Number of Recog. Words: "
			    +"( "+ words.length +" )"
			    +"\n"+" Saved wav File : " +"( "+ now()+".wav"+" )"+" in " +"tjr@it-tjr13.dhbw-stuttgart.de/zanzibar-SNAPSHOT/bin/cairo/c:/temp/"
		            +"\n"+"-------------------------------------------------"; 
	System.out.println("\n"+"-------------------------------------------------"+"\n"+recogResult);
	/*System.out.println("-------------------------------------------------");
	System.out.println("Time ("+now()+")");
	System.out.println("-------------------------------------------------");
	System.out.println("Utterance String " +"( "+result.getUtterance()+")");
        System.out.println("-------------------------------------------------");
	...
	System.out.println("-------------------------------------------------");
	String [] words = result.getWords();
	System.out.println("Number of words recognized :"+ words.length);
        System.out.println("-------------------------------------------------");
	System.out.println("Word 1 "+"( "+words[0]+" )");
        System.out.println("-------------------------------------------------");
	float [] wordsConf = result.getWordsConfidence();
        System.out.println("word 1 Confidence "+"("+wordsConf[0]+")");
        System.out.println("-------------------------------------------------");
	*/
	try{
		 FileWriter fstream = new FileWriter("recog.txt",true);
 		 BufferedWriter out = new BufferedWriter(fstream);
		 out.write(recogResult);
 		 out.close();
 	 }catch (Exception e){
